...
Risk implementation is deferred to M6. Its non-negotiable invariant is that position quantity derives from maximum defined loss and account equity—not available margin. M1 cannot submit orders.
