...
function App() {
  ...
  const content = useMemo(() => {
    ...
    if (route === 'Settings') return <section className="panel settings-panel"><header><div><p className="eyebrow">Read-only safety state</p><h2>Runtime settings</h2></div></header><div className="notice"><ShieldCheck /> Live trading cannot be armed from this dashboard. Environment gate, heartbeat and reconciliation are required in later milestones.</div></section>
